...
import {initMap, changeView, removeMap} from '../../helpers/leaflet.js'
...
const Weather3 = () => {
    ...
    {
        if(data)
            changeView([data.coord.lat, data.coord.lon], data.weather[0].description)
    ...
    return (
        <div className='weather'>
            ...
            <div id='mapcontainer' style={{width: '300px', height: '300px', backgroundColor: 'silver'}}>
                    Kortet er på vej
            </div>
        </div>
    )
